<template>
  <div class="app-container">
    ...
    <div :key="key" style="margin-top:30px;">
      ...
      <div>
        <span v-permission="['normal']" class="permission-alert">
          Only
          <el-tag class="permission-tag" size="small">normal</el-tag> can see
          this
        </span>
        <el-tag
          v-permission="['normal']"
    ...
    <div :key="'checkPermission' + key" style="margin-top:60px;">
      ...
      <el-tabs type="border-card" style="width:550px;">
        ...
        <el-tab-pane v-if="checkPermission(['normal'])" label="Normal">
          Normal can see this
          <el-tag class="permission-sourceCode" type="info"
            >v-if="checkPermission(['normal'])"</el-tag
          >
        </el-tab-pane>
