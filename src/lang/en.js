export default {
  ...
  dashboard: {
    title: "Your roles",
    editor: "Editor's Role Dashboard",
    normal: "Normal's Role Dashboard",
    test: "Test's Role Dashboard"
  },
  login: {
    title: "Login Form",
    login: "Log in",
    ...
    register: "Register",
    registerTips:
      "Can not be register on local, so please combine you own business simulation! ! !",
    otherLogin: "Or connect with",
    otherLoginTips:
